...
user1 = np.array([[20, 0, 0], [0, 20, 0], [0, 0, 20]])
user2 = np.array([[19, 0, 1], [1, 18, 1], [0, 0, 20]])
user3 = np.array([[18, 1, 1], [1, 19, 0], [0, 1, 19]])
user4 = np.array([[20, 0, 0], [0, 20, 0], [0, 0, 20]])
user5 = np.array([[20, 0, 0], [0, 19, 1], [0, 0, 20]])
user6 = np.array([[20, 0, 0], [0, 20, 0], [0, 1, 19]])
user7 = np.array([[18, 1, 1], [1, 18, 1], [0, 1, 19]])
user8 = np.array([[19, 1, 0], [1, 18, 1], [0, 4, 16]])
user9 = np.array([[18, 0, 2], [1, 18, 1], [2, 0, 18]])
user10 = np.array([[18, 2, 0], [1, 18, 1], [0, 2, 18]])
user11 = np.array([[20, 0, 0], [0, 19, 1], [0, 0, 20]])
user12 = np.array([[20, 0, 0], [0, 20, 0], [0, 0, 20]])
...
plt.savefig("fig/rm_confusion_matrix_no_attention.jpg", dpi=500)
