...
class CNNnet(torch.nn.Module):
    def __init__(self):
        ...
        self.mlp1_1 = torch.nn.Linear(2 * 3 * 4, 16)
        self.mlp1_2 = torch.nn.Linear(2 * 3 * 4, 16)
        self.mlp1_3 = torch.nn.Linear(2 * 3 * 4, 16)
        self.mlp2_1 = torch.nn.Linear(16, 5)
        self.mlp2_2 = torch.nn.Linear(16, 2)
        self.mlp2_3 = torch.nn.Linear(16, 7)
